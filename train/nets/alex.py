...
def topK_acc(y_test, X_test, num_classes):
    ...
    for i, l in enumerate(np.argmax(y_test, axis=1)):
        ...
        print('X_test: ', X_test, 'y_test:', y_test, 'y_pred :', class_probs, 'max y_test', np.argmax(y_test, axis=1))
        print("show up ", type(top_5_values), top_5_values.shape, top_5_values)
        if top_5_values[0] == l:
            top1 += 1.0
